...
export default function AttendanceToggle({
  ...
  const [value, _setValue] = useState<Attendance>(initial)
  ...
  // biome-ignore lint/suspicious/noExplicitAny: lint:apps:check
  ...
  return (
    <div className="flex gap-2">
      <ToggleGroup defaultValue="indeterminate" type="single">
        {options.map((opt) => {
          const Icon = opt.icon
