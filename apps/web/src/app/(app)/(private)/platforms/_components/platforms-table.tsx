...
import { LoadingPlatforms } from './loading-platform'
...
interface TableProps {
  ...
  ) => Promise<InfiniteQueryObserverResult<InfiniteData<PaginatedPlatforms, unknown>, Error>>
}
        ...
        <div className="h-[700px] overflow-visible" ref={parentRef}>
          ...
          >
            {rowVirtualizer.getVirtualItems().map((virtualRow) => {
              const isLoader = virtualRow.index === allPlatforms.length
              const platform = allPlatforms[virtualRow.index]
