        ...
        <AnimatePresence initial={false}>
          {isActive && type === 'single' && (
            <motion.span
              ...
              exit={{ opacity: 0 }}
              transition={transition}
              className={cn('absolute inset-0 z-0 rounded-full bg-muted', activeClassName)}
            />
          )}
        </AnimatePresence>
      </motion.button>
