...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root {...props} onCheckedChange={handleCheckedChange} asChild>
      <motion.button
        data-slot="switch"
        className={cn(
      ...
      >
        {leftIcon && (
          <motion.div
            ...
            className="-translate-y-1/2 absolute top-1/2 left-1 text-neutral-400 dark:text-neutral-500 [&_svg]:size-3"
          >
        ...
        {rightIcon && (
          <motion.div
            ...
            transition={{ type: 'spring', bounce: 0 }}
            className="-translate-y-1/2 absolute top-1/2 right-1 text-neutral-500 dark:text-neutral-400 [&_svg]:size-3"
          >
