...
function TabsList({
  ...
  return (
    <MotionHighlight
      controlledItems
      className={cn('rounded-sm bg-primary shadow-sm', activeClassName)}
      value={activeValue}
      transition={transition}
    >
      <TabsPrimitive.List
        ...
        data-slot="tabs-list"
        className={cn(
          'inline-flex h-15 w-fit items-center justify-center rounded-lg bg-muted p-[4px] text-muted-foreground',
          className,
        )}
        {...props}
      >
